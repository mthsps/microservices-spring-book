...
public class ChallengeEventPubTest {
    ...
    public void setUp() {
        challengeEventPub
                = new ChallengeEventPub(amqpTemplate, "test.topic");
    ...
    private ChallengeSolvedEvent solvedEvent(boolean correct) {
        return new ChallengeSolvedEvent(1L, correct, 30, 40, 10L, "alas");
    }

    private ChallengeAttempt createTestAttempt(boolean correct) {
        return new ChallengeAttempt(1L, new User(10L, "alas"), 30, 40,
